...
// Function to calculate letter grade and validate score input
char getGrade(int score) {
    // 1. Validation check for out-of-range scores
    if (score < 0 || score > 100) {
        return '\0'; // Return null character to indicate invalid score
    }
...
int main() {
    ...
    // Handle output or error message based on the returned grade
    if (grade == '\0') {
